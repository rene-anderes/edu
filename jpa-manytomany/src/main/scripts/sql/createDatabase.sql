...
CREATE TABLE NP_MAPPED (ID BIGINT NOT NULL, FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), PERSON_NR INTEGER, PRIMARY KEY (ID));
CREATE TABLE JP_MAPPED (ID BIGINT NOT NULL, LEGALFORM VARCHAR(255), PERSON_NR INTEGER, PRIMARY KEY (ID));
