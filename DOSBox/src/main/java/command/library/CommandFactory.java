...
public class CommandFactory {
    ...
    private void createCommandList(Drive drive) {
        ...
        this.commands.add(new CmdDate("date", drive));
        this.commands.add(new CmdFormat("format", drive));
        this.commands.add(new CmdRename("ren", drive));
        this.commands.add(new CmdRename("rename", drive));
        this.commands.add(new CmdType("type", drive));
        this.commands.add(new CmdType("cat", drive));
        this.commands.add(new CmdHelp("help", drive, this));
    }
    ...
    private void createHelpTexts() {
        ...
        helpTexts.put("exit", "Quits the program.");
        helpTexts.put("ver", "Display the version.");
        helpTexts.put("time", "Displays or sets the system time.");
        helpTexts.put("date", "Displays or sets the date.");
        helpTexts.put("format", "Formats a disk.");
        helpTexts.put("ren", "Renames a file.");
        helpTexts.put("rename", "Renames a file.");
        helpTexts.put("type", "Display a filecontent.");
        helpTexts.put("cat", "Display a filecontent.");
        helpTexts.put("help", "For more information on a specific command, type HELP command-name");
    }
