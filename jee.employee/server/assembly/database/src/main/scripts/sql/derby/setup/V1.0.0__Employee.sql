...
CREATE TABLE PARKINGSPACE (
	...
	CONSTRAINT TBL_PARKINGSPACE_PK PRIMARY KEY (PS_ID)
);
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT EMPLOYEE_PS_ID FOREIGN KEY (PARKINGSPACE_ID) REFERENCES PARKINGSPACE(PS_ID);
