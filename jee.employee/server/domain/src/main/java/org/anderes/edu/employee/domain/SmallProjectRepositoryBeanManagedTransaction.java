...
import org.anderes.edu.employee.domain.SmallProject_;

/**
 * Beispiel eines Repositories (hier für {@code SmallProject}),
 * das das Transaktions-Management selber übernimmt.
 * 
 * @author René Anderes
 *
 */
public class SmallProjectRepositoryBeanManagedTransaction {
    ...
    private void deleteLocal(final SmallProject entity, final EntityManager entityManager) throws Exception {
        utx.begin();
